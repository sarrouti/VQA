...
if __name__ == '__main__':
    ...
    parser.add_argument('--vocab-path', type=str,
                        default='data/processed_add2019/vocab_vqa.json',
                        help='Path for vocabulary wrapper.')
    parser.add_argument('--dataset', type=str,
                        default='data/processed_add2019/vqa_dataset.hdf5',
    ...
    parser.add_argument('--train-dataset-weights', type=str,
                        default='data/processed/vqa_train_dataset_weights.json',
                        help='Location of sampling weights for training set.')
    parser.add_argument('--val-dataset-weights', type=str,
                        default='data/processed/vqa_test_dataset_weights.json',
                        help='Location of sampling weights for training set.')
