...
if __name__ == '__main__':
    ...
    #parser.add_argument('--image-dir', type=str, default='/home/sarroutim2/PosDoc NLM/VQA/Codes/IQ/VQA-MeD-CELF/data_processing/ImageClef-2020/VQA-Med-2020-Task1-VQAnswering-TrainVal-Sets/VQA-Med-2020-Task1-VQAnswering-TrainVal-Sets/VQAMed2020-VQAnswering-ValidationSet/VQAnswering_2020_Val_images/',                        
     #                   help='directory for resized images')
    parser.add_argument('--image-dir', type=str, default='/home/sarroutim2/PosDoc NLM/VQA/Codes/IQ/VQA-MeD-CELF/data_processing/ImageClef-2020/VQA-Med-2020-Task1-VQAnswering-TrainVal-Sets/VQA-Med-2020-Task1-VQAnswering-TrainVal-Sets/VQAMed2020-VQAnswering-TrainingSet/VQAnswering_2020_Train_images/',                        
                        help='directory for resized images')   
    
    parser.add_argument('--questions', type=str,
                        default='data/vqa/'
                        'vqa-imageclef-2020-train_aug_and_2019-2018.json',
                        help='Path for train annotation file.')
    parser.add_argument('--vocab-path', type=str,
                        default='data/processed/vocab_vqa.json',
                        help='Path for saving vocabulary wrapper.')

    # Outputs.
    parser.add_argument('--output', type=str,
                        default='data/processed/vqa_dataset.hdf5',
                        help='directory for resized images.')
